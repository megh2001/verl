#!/bin/bash
# Baseline evaluation: Student model only (no teacher hints)
# This establishes the baseline performance before training
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='baseline_student_only' \
